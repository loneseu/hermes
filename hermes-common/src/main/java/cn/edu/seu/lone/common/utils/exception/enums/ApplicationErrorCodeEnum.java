...
public enum ApplicationErrorCodeEnum implements ErrorCodeEnum{
    ...
    SUCCESS("200", "成功"),
    FAILURE("300", "系统异常"),
    SYSTEM_BUSY("301", "系统繁忙, 请稍候重试!"),
    SYSTEM_FLOW("302", "系统峰值， 请稍后请求！"),
    SYSTEM_NOT_VALID_TOKEN("303", "未能获取有效的TOKEN信息!"),
    SYSTEM_NOT_ACCESS_USER("304", "未能获取有效的用户信息!"),
    SYSTEM_NOT_VALID_REQUEST("305", "非法请求，未授予菜单权限！"),
    ...
    // 代理服务的异常信息
    NOT_FOUND_PROCESSOR(ErrorCodeEnum.MODULE_PROXY, "300001", "不支持的业务处理数据， 请检查！"),
    NOT_VALID_LOGIN(ErrorCodeEnum.MODULE_PROXY, "300002", "用户未登陆或已过期， 请重新登陆！"),

    // 交易服务异常码
    QUOTE_LAST_PRICE_NOT_FOUND(ErrorCodeEnum.MODULE_DEAL, "400001", "未获取最新行情报价， 请稍后重试！"),
    NO_STOCK_POSITION_DATA(ErrorCodeEnum.MODULE_DEAL, "400002", "没有持仓信息！"),
    NO_ENOUGH_POSITION_VOLUME(ErrorCodeEnum.MODULE_DEAL, "400003", "持仓数量不足！"),

    // 挂单服务异常码
    ORDER_HAS_PROCESSED(ErrorCodeEnum.MODULE_PENDING, "500001", "订单已处理！"),
    ORDER_NOT_FOUND(ErrorCodeEnum.MODULE_PENDING, "500002", "未找到订单！"),
    ORDER_NOT_RECALL(ErrorCodeEnum.MODULE_PENDING, "500003", "订单不能撤回！请检查是否已成交或撤回！"),
    ACCOUNT_NOT_MATCH(ErrorCodeEnum.MODULE_PENDING, "500004", "账号信息不一致！不能作此操作！"),

    //资金服务
    ACCOUNT_NOT_FOUND(ErrorCodeEnum.MODULE_FINANCE, "600001", "用户账号不存在！"),
    BALANCE_NOT_ENOUGH(ErrorCodeEnum.MODULE_FINANCE, "600002", "可用资金不足！"),
    ;
     ...
     * 错误级别
     */
    private final WarningLevelEnum warningLevel;
    ...
    public String getCode() {
        return Objects.nonNull(this.module) ? this.module + this.code : ErrorCodeEnum.MODULE_SYSTEM + this.code;
    }
